...
private:
	...
	NetClientInfoVecterType			m_vecNetClientInfoAll;		// 连接外部服务器信息 
	NetClientInfoVecterType			m_vecNetClientInfoAdd;		// 新增的连接信息
	DisconnectServerIDVectorType	m_vecNetClientDisConnect;	// 断开连接的服务器ID 
