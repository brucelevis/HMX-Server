...
{
	E_CHANNEL_REGIST_TYPE_NULL			= 0x0000000,	// 无 
	E_CHANNEL_REGIST_TYPE_POS_B			= 0x00000001,	// 位置信息广播 
	E_CHANNEL_REGIST_TYPE_POS_R			= 0x00000002,	// 位置信息收集 
	E_CHANNEL_REGIST_TYPE_CREATURE_B	= 0x00000004,	// 生物体信息广播 
	E_CHANNEL_REGIST_TYPE_CREATURE_R	= 0x00000008,	// 生物体信息收集 
	E_CHANNEL_REGIST_TYPE_EQUIP_B		= 0x00000010,   // 装备广播 
	E_CHANNEL_REGIST_TYPE_EQUIP_R		= 0x00000020,   // 装备收集 
	E_CHANNEL_REGIST_TYPE_SPELL_B		= 0x00000040,	// 技能广播 
	E_CHANNEL_REGIST_TYPE_SPELL_R		= 0x00000080,   // 技能收集 
	E_CHANNEL_REGIST_TYPE_BUFF_B		= 0x00000100,	// Buff信息广播	 
	E_CHANNEL_REGIST_TYPE_BUFF_R		= 0x00000200,	// Buff信息收集 
	E_CHANNEL_REGIST_TYPE_MAX
};
