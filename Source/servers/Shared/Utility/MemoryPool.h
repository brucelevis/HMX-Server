...
#define SET_UNUSE_BLOCK_HEAD(length)		((length) | MEMORY_BLOCK_MASK)
#define EXCHANGE_BLOCK_INUSE(head)			((head) |= MEMORY_BLOCK_INUSE)
#define EXCHANGE_BLOCK_UNUSE(head)			((head) &= ~MEMORY_BLOCK_INUSE)

#define GET_BLOCK_LENGTH(head)	((head) & MEMORY_BLOCK_LENGTH_SECTION)
#define IS_INUSE(head)		(bool)((head) & MEMORY_BLOCK_INUSE)
#define IS_MASK_OK(head)	(MEMORY_BLOCK_MASK == ((head) & ~(MEMORY_BLOCK_INUSE|MEMORY_BLOCK_LENGTH_SECTION)))
