...
extern DbConnManager* gDbServerMgr;
...
// 002000
	/*for (int32 i = 0;i < 10 ; i++)
	{
		...
		if(HttpGet("hq.sinajs.cn",ss.str().c_str(),reponse) == 0)
		{
			...
			gDbServerMgr->GetMainDB()->ExecInsert("stock_info",FieldInfoDefine,(char*)&stockTmp);
		}
	}*/
...
void StockCrawl::Start()
{
	...
	IDbBase* pDb = gDbServerMgr->AddDatabase(rDbInfo.strHost.c_str(),rDbInfo.strUser.c_str(),rDbInfo.strPass.c_str(),"stock_data");
	if(pDb == NULL)
	{
